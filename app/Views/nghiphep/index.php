            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class = "mb-3">
                    <?php if(hasPermission('XUAT_NGHI_PHEP_EXCEL')): ?>
                        <a href="<?= base_url('nghi_phep/export_excel') ?>" class="btn btn-success"><i class="fa-solid fa-file-excel"></i><span> Xuất Excel</span></a>
                    <?php endif; ?>

                    <?php if(hasPermission('XUAT_NGHI_PHEP_PDF')): ?>
                        <a href="<?= base_url('nghi_phep/export_pdf') ?>" class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i><span> Xuất PDF</span></a>
                    <?php endif; ?>
