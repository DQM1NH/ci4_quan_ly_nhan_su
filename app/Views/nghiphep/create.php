    ...
    <div class="flex-grow-1 main-content">
        <div class="container-fluid mt-3">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="/ci4_quan_ly_nhan_su/nghi_phep/store" method="post" id="formNghiPhep">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="loai_nghi_phep_id" class="form-select" required>
                                        <?php foreach($loainghis as $item): ?>
                                            <option value="<?= $item['loai_nghi_phep_id'] ?>">
                                                <?= $item['ten_loai_nghi'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="ly_do" rows="5" class="form-control"></textarea>
                        </div>
...
<script>
    document.getElementById("formNghiPhep").addEventListener("submit", function(e){
        ...
        let loaiNghiPhep = document.querySelector('select[name="loai_nghi_phep_id"]').value.trim();
        let ngayBatDau = document.querySelector('input[name="ngay_bat_dau"]').value;
        let ngayKetThuc = document.querySelector('input[name="ngay_ket_thuc"]').value;
        ...
        let total = end.getdate() - start.getdate();
        ...
        if(total < 0){
            ...
            Swal.fire({
                ...
                text: 'Ngày kêt thúc phải lơn hơn ngày bắt đầu!'
            });
