        ...
        <div class="container-fluid mt-3">
            <div class="card shadow">
                <div class="card-header">
                    <h3>Cập nhật đơn nghỉ phép</h3>
                </div>

                <div class="card-body">
                    <form action="/nghi_phep/update/<?= $don['don_nghi_phep_id'] ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="nhan_vien_id" class="form-select">
                                        <?php foreach($nhanviens as $nv): ?>
                                            <option value="<?= $nv['nhan_vien_id'] ?>" <?= $nv['nhan_vien_id'] == $don['nhan_vien_id'] ? 'selected' : '' ?>>
                                                <?= $nv['ho_ten'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="loai_nghi_phep_id" class="form-select">
                                        <?php foreach($loainghis as $item): ?>
                                            <option value="<?= $item['loai_nghi_phep_id'] ?>" <?= $item['loai_nghi_phep_id'] == $don['loai_nghi_phep_id'] ? 'selected' : '' ?>>
                                                <?= $item['ten_loai_nghi'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="ngay_bat_dau" value="<?= $don['ngay_bat_dau'] ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="ngay_ket_thuc" value="<?= $don['ngay_ket_thuc'] ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="ly_do" rows="5" class="form-control"><?= $don['ly_do'] ?></textarea>
                        </div>

                        <button type="submit" class="btn btn-primary btn-update">Cập nhật</button>
                        <a href="/nghi_phep" class="btn btn-secondary">Quay lại</a>
                    </form>
                </div>
            </div>
        </div>
