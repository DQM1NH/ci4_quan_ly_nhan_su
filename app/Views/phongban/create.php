    ...
    <div class="flex-grow-1 main-content">
        <div class="container mt-3">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="/ci4_quan_ly_nhan_su/phong_ban/store" method="post" id="formPhongBan">
                        <div class="mb-3">
                            <label>Tên phòng ban</label>
                            <input type="text" name="ten_phong_ban" class="form-control">
                        </div>
...
<script>
    document.getElementById("formPhongBan").addEventListener("submit", function(e){

        let tenphongban = document.querySelector('input[name="ten_phong_ban"]').value.trim();
